...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "Nishit");
    }

    public void enterLastName() {
        sendTextToElement(lastName, "Chitaliya");
    }
    ...
    public void enterPassword() {
        sendTextToElement(password, "Nishit8664");
    }

    public void enterConfirmPassword() {
        sendTextToElement(confirmPassword, "Nishit8664");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "nishitchitaliya@gmail.com");
    }
